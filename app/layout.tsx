            ...
            <footer className="border-t border-[rgba(0,255,135,0.08)] py-8 mt-16">
              <div className="container">
                <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                  ...
                  <p className="text-xs text-white/25 font-mono">© 2025 CodeBuddy · Built with ⚡ by <span className="text-[var(--neon-green)] opacity-80">Khushant Sharma</span></p>
                  <div className="flex gap-6">
                    <Link href="/terms" className="text-xs text-white/30 hover:text-[var(--neon-green)] transition-colors font-mono">Terms</Link>
                    <Link href="/privacy" className="text-xs text-white/30 hover:text-[var(--neon-green)] transition-colors font-mono">Privacy</Link>
                    <Link href="/docs" className="text-xs text-white/30 hover:text-[var(--neon-green)] transition-colors font-mono">Docs</Link>
                  </div>
                </div>
              </div>
            </footer>
